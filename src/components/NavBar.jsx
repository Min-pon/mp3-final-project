...
export default function NavBar() {
  ...
  return (
    <div>
      {isMobile ? (
        <div className="flex flex-row bg-secondary text-white py-[8px] justify-between h-[56px] pl-[16px] pr-[8px] w-full fixed">
        ...
        <div className="flex flex-row bg-secondary text-white py-[10px] items-center justify-between h-[60px] px-[160px] w-full fixed">
